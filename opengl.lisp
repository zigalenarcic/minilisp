...
(define-c-function lib-gl "glColor4d" '(f64 f64 f64 f64))
...
(define-c-function lib-gl "glPolygonMode" '(i64 i64))
(define-c-function lib-gl "glDepthMask" '(i64))
(define-c-function lib-gl "glLightf" '(i64 i64 f32))
(define-c-function lib-gl "glLighti" '(i64 i64 i64))
(define-c-function lib-gl "glLightfv" '(i64 i64 i64))
(define-c-function lib-gl "glLightiv" '(i64 i64 i64))
