...
(set lib-glfw (load-library "libglfw.so"))
...
(define-c-function lib-glfw "glfwInit")
(define-c-function lib-glfw "glfwTerminate")
(define-c-function lib-glfw "glfwSetErrorCallback")

(define-c-function lib-glfw "glfwSwapInterval" '(i64))
(define-c-function lib-glfw "glfwSwapBuffers" '(i64))
(define-c-function lib-glfw "glfwCreateWindow" '(i64 i64 i64 i64 i64))
(define-c-function lib-glfw "glfwMakeContextCurrent" '(i64))
(define-c-function lib-glfw "glfwPollEvents")
(define-c-function lib-glfw "glfwWindowShouldClose" '(i64))
(define-c-function lib-glfw "glfwDestroyWindow" '(i64))
(define-c-function lib-glfw "glfwSetWindowSize" '(i64 i64 i64))
(define-c-function lib-glfw "glfwGetWindowSize" '(i64 i64 i64))
(define-c-function lib-glfw "glfwGetFramebufferSize" '(i64 i64 i64))

(define-c-function lib-glfw "glfwGetCursorPos" '(i64 i64 i64))
(define-c-function lib-glfw "glfwSetInputMode" '(i64 i64 i64))
(define-c-function lib-glfw "glfwRawMouseMotionSupported" n)

(define-c-function lib-glfw "glfwGetKey" '(i64 i64))
(define-c-function lib-glfw "glfwSetKeyCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetCharCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetCursorPosCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetCursorEnterCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetMouseButtonCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetScrollCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetWindowSizeCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetFramebufferSizeCallback" '(i64 i64))
(define-c-function lib-glfw "glfwSetWindowCloseCallback" '(i64 i64))
